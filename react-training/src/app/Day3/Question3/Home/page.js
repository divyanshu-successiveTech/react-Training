...
function HomeQuestion(){
    ...
    return(
        ...
        <Link href= "/Day3/Question5/Dashboard">To DashBoard</Link><br/><br/>

        To go to Profile<br/>
        <Link href= "/Day3/Question5/Profile">To Profile</Link><br/><br/>

        To go to Settings<br/>
        <Link href= "/Day3/Question5/Settings">To Settings</Link><br/><br/>
